                    ...
                    <div class="details">
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-5">
                                ...
                                <a href="./doc/RULEBOOK UX DESIGN TF 9.0.pdf" class="btn btn-dark a1" download><i class="bi bi-download"></i> Rulebook</a>
                            </div>
                    ...
                    <ul class="faq-list">
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq11" class="collapsed question">
                                Bolehkah tim saya mendaftar jika berasal dari jenjang pendidikan berbeda (seperti D4 dan S1 dalam 1 tim) maupun dari jurusan yang berbeda?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                            <div id="faq11" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Boleh, dengan ketentuan peserta berasal dari perguruan tinggi/instansi terkait yang sama.
                                </p>
                            </div>
                        </li>
