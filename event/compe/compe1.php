...
<main id="main" class="main-page">
    ...
    <section id="speakers-details">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <img src="../../assets/img/event/infographic.png" alt="Speaker 1" class="img-fluid">
                </div>
                ...
                <div class="col-md-8 my-auto">
                    <div class="details">
                        ...
                        <p>Kompetisi Infographic adalah kompetisi yang terdiri dari maksimal tiga
                            orang dalam satu tim yang akan menciptakan sebuah poster yang
                            mengandung pesan atau informasi sesuai dengan tema yang telah ditentukan,
                            yaitu “Impact Cause by Implementing Technological Developments in the
                            Disruptive Era, Strategy to Implement Technological Developments in the
                            Disruptive Era, dan Challenge of Implementing Technological
                            Developments in the Disruptive Era”.
                        </p>
                        <div class="row">
                            <div class="col-md-5 mb-5">
                                ...
                                <a href="./doc/RULEBOOK INFOGRAPHIC TF 9.0.pdf" class="btn btn-dark a1" download><i class="bi bi-download"></i> Rulebook</a>
                            </div>
                            <div class="col-md-7 text-center">
                                <div class="card text-center" data-tilt data-tilt-scale="1.1">
                                    ...
                                    <h1>Jutaan Rupiah</h1>
                                    <h3>E-Certificate +</h3>
                                    <h3>Paragon E-Voucher Discount</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <p>Rp. 30,000 / karya atau Rp. 55,000 / 2 karya</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="timeline">
                <div class="containers left">
                    ...
                    <div class="content">
                        ...
                        <h2>Pendaftaran & Batas Submit Karya dan Berkas</h2>
                        <p><?= $tgl; ?> April - 26 Mei 2022</p>
                    </div>
                </div>
                ...
                <div class="containers left">
                    <div class="content">
                        ...
                        <h2>Babak E-voting</h2>
                        <p>27 Mei 2022 - 3 Juni 2022</p>
                    </div>
                </div>
                <div class="containers right">
                    <div class="content">
                    ...
                    <ul class="faq-list">
                        ...
                        <li>
                            <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">
                                Bagaimana cara mendaftarkan diri dalam kompetisi Infographic TechnoFair 9.0?
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">
                                Bagaimana sistem kompetisi Infographic?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                            <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Pada kompetisi ini terdapat 2 babak, babak penyisihan berupa penilaian oleh para juri melalui beberapa aspek/poin penilaian yang sudah ditentukan dan babak e-voting berupa penilaian audiens (like, view, share) dari poster yang akan diunggah di Instagram TechnoFair 9.0 (@technofair).</p>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div id="faq5" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Tidak, karya yang pernah diikuti dalam kompetisi lain tidak boleh diikut sertakan. Jika ketahuan maka peserta akan <b>didiskualifikasi</b>.</p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq7" class="collapsed question">
                                Bolehkah mendaftar jika kelompok saya hanya terdiri dari 2 orang peserta?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq8" class="collapsed question">
                                Bagaimana saya bisa mendapatkan template narasi singkat, lembar orisinalitas, dan logo?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                            <div id="faq8" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Template narasi singkat, lembar orisinalitas, dan logo dapat diunduh pada website TechnoFair 9.0 (www.technofair.id).
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div id="faq9" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Kompetisi ini dikhususkan untuk Siswa SMA/Sederajat dan mahasiswa yang masih aktif. Namun, tidak ada perbedaan kategori SMA/SMK dan mahasiswa.
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq11" class="collapsed question">
                                Bolehkah tim saya mendaftar jika berasal dari jenjang pendidikan berbeda (seperti D4 dan S1 dalam 1 tim atau kelas 10 dan kelas 12 dalam 1 tim) maupun dari jurusan yang berbeda?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                            <div id="faq11" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Boleh, dengan ketentuan peserta berasal dari universitas/instansi terkait yang sama.
                                </p>
                            </div>
                        </li>
