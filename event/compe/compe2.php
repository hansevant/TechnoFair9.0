...
<main id="main" class="main-page">
    ...
    <section id="speakers-details">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <img src="../../assets/img/event/fiktic.png" alt="Speaker 1" class="img-fluid">
                </div>
                ...
                <div class="col-md-8 my-auto">
                    <div class="details">
                        ...
                        <p>Kompetisi Smart FIKTI adalah kompetisi cerdas cermat tanya jawab yang mengusung tema pengetahuan umum dan teknologi yang dimana kompetisi ini dikhususkan untuk Mahasiswa Universitas Gunadarma dan terdiri dari tiga orang dalam satu tim.</p>
                        <div class="row">
                            <div class="col-md-5 mb-5">
                                ...
                                <a href="./doc/RULEBOOK SMART FIKTI TF 9.0.pdf" class="btn btn-dark a1" download><i class="bi bi-download"></i> Rulebook</a>
                            </div>
                    ...
                    <ul class="faq-list">
                        ...
                        <li>
                            <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">
                                Bagaimana cara mendaftarkan diri dalam kompetisi Smart FIKTI TechnoFair 9.0?
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">
                                Bagaimana apabila pendaftar tidak memiliki KTM (Kartu Tanda Mahasiswa)?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                            <div id="faq3" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Dapat digantikan dengan Kartu Rencana Studi yang aktif.
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div data-bs-toggle="collapse" href="#faq4" class="collapsed question">
                                Bagaimana sistem kompetisi Smart FIKTI?
                                <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i>
                            </div>
                        ...
                        <li>
                            ...
                            <div id="faq9" class="collapse" data-bs-parent=".faq-list">
                                <p>
                                    Peserta kompetisi Smart FIKTI adalah khusus mahasiswa FIKTI Universitas Gunadarma.
                                </p>
                            </div>
                        </li>
