        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    ...
                    <?php
                    $queries = mysqli_query($con, "SELECT * FROM webinar WHERE `event` = 'Smart City' ");
                    ?>


                    <h3 class="d-inline mr-3">Data Pendaftar Webinar Smart City</h3> <a href="export/smartcity.php" class="btn btn-success">export sini gan</a>
                                ...
                                <table class="table table-hover table-bordered display">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="bg-cyan text-center">IAlasan</th>
