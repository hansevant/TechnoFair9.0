...
<b>Mohon maaf pembayaran anda ditolak silahkan periksa kembali data anda</b>
...
if (!$mail->send()) {
    ...
    $queries = mysqli_query($con, "UPDATE user_payment SET stat_payment = 2 WHERE id_user = '$id_user' ");
