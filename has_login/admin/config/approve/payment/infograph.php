...
<b>Selamat berkas anda telah diterima. Selanjutnya anda akan melanjutkan tahap persiapan kompetisi :</b>
<br>
<br>

1.Wajib mengunduh dokumen dibawah ini dan diunggah kembali pada halaman user :<br>

-Lembar Orisinalitas<br>
https://bit.ly/LembarPernyataanOrisinalitasTF9
<br>
-Narasi Singkat<br>
https://bit.ly/LembarNarasiSingkatTF9
<br>
<br>

2. Lengkapi berkas kompetisi dengan mengunggah dokumen pada halaman user anda menggunakan format file .zip
<br>
<br>
...
if (!$mail->send()) {
    ...
    location.href='../../../infographic.php';</script>";
}
