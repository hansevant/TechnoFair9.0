...
<b>Selamat berkas anda telah diterima silahkan periksa halaman user anda</b>
<br>
<br>
1. Silahkan join grup untuk informasi selanjutnya melalui link berikut : <br>
https://bit.ly/GroupPesertaSmartFIKTI_TF9
<br>
<br>

2. Periksa kembali halaman user anda
<br>
<br>
...
if (!$mail->send()) {
    ...
    $queries = mysqli_query($con, "UPDATE user_berkas SET stat_berkas = 3 WHERE id_user = '$id_user' ");

    echo "<script>alert('Berkas Has Been Approved'); 
    location.href='../../../smart_fikti.php';</script>";
}
