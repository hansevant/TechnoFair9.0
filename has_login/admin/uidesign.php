        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    ...
                    <?php
                    $queries = mysqli_query($con, "SELECT * FROM workshop WHERE `event` = 'UI Design' ");
                    ?>


                    <h3>Data Pendaftar Workshop UI Design</h3>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="../../regist/payment/<?= $data['payment'] ?>" target="_blank">CLICK</a>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton1">
                                                            <form action="config/approve/payment/ui.php" method="post">
                                                            ...
                                                            <br>
                                                            <form action="config/reject/payment/ui.php" method="post">
                                                                <input type="text" name="id" value="<?= $id ?>" hidden>
                                                                <input type="text" name="nama" value="<?= $nama ?>" hidden>
                                                                <input type="text" name="email" value="<?= $email ?>" hidden>
