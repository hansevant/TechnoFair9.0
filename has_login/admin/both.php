        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    ...
                    <?php
                    $queries = mysqli_query($con, "SELECT * FROM workshop WHERE `event` = 'Both' ");
                    ?>


                    <h3>Data Pendaftar Workshop Keduanya</h3>
                                            ...
                                            <tr>
                                                ...
                                                <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuSizeButton1">
                                                            <form action="config/approve/payment/both.php" method="post">
                                                            ...
                                                            <br>
                                                            <form action="config/reject/payment/both.php" method="post">
                                                                <input type="text" name="id" value="<?= $id ?>" hidden>
                                                                <input type="text" name="nama" value="<?= $nama ?>" hidden>
                                                                <input type="text" name="email" value="<?= $email ?>" hidden>
